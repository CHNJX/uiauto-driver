...
from base.Common import PAGE_DIR
...
class BasePage:
    page_path = PAGE_DIR + '/index_page/'
    back_btn = page_path + 'back.png'
    up_btn = page_path + 'up.png'
    close_tips_btn = page_path + 'close_tips_btn.png'
    back_btn_advance = page_path + 'back_btn_advance.png'

    def __init__(self, device=None, device_ip="10.2.16.127:5555"):
        self._element = None
        self._result = None
